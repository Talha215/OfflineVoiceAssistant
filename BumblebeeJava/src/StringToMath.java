        ...
        for (int i = 0; i < singleWords.length; i++) {
            ...
            if (singleWords[i].equals("twenty")) {
                ...
                if (i + 1 < singleWords.length) {
                    i++;
                    switch (singleWords[i]) {
                        case "one" -> outPut = outPut + "1";
                        case "two", "to", "too" -> outPut = outPut + "2";
                        case "three" -> outPut = outPut + "3";
                        case "four", "for" -> outPut = outPut + "4";
                        case "five" -> outPut = outPut + "5";
                        case "six" -> outPut = outPut + "6";
                        case "seven" -> outPut = outPut + "7";
                        case "eight" -> outPut = outPut + "8";
                        case "nine" -> outPut = outPut + "9";
